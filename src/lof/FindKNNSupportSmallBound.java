...
public class FindKNNSupportSmallBound {
	/**
	 * default Map class.
	 *
	 * @author Yizhou Yan
...
//			float partitionExpand = 0.0f;
	...
	/*		for (MetricObject entry : sortedData) {
			...
			for (int i = 0; i < sortedData.size(); i++) {
				...
				partitionExpand = maxOfTwoFloatArray(partitionExpand,boundSupportingArea(o_S);
	...
	public void run(String[] args) throws Exception {
		...
		job.setJarByClass(FindKNNSupportSmallBound.class);
	...
	public static void main(String[] args) throws Exception {
		FindKNNSupportSmallBound findKnnAndSupporting = new FindKNNSupportSmallBound();
